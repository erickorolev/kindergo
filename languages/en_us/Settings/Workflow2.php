...
$languageStrings = array (
  ...
  'LBL_MAILSCANNER_TRIGGER' => 'Used in Mailscanner',
    ...
    'Environment ID of records' => 'Environment ID of records',
    'Records are in Module' => 'Records are in Module',
    'This Block works only if you previously store some recordIds in the Environment. (Could be done in "global Search" or "exist Related record")' => 'This Block works only if you previously store some recordIds in the Environment. (Could be done in "global Search" or "exist Related record")',
    'Show total row' => 'Show total row',
    'to use this list use the following function' => 'to use this list use the following function',
    'To include this list into PDFMaker use' => 'To include this list into PDFMaker use',
    'Set Preset' => 'Load Preset',
    'Daily' => 'Daily',
    'Workdays once' => 'Workdays once',
    'Workdays hourly' => 'Workdays hourly',
    'Every Monday' => 'Every Monday',
    'Monthly first day' => 'Monthly first day',
    'Next execution:' => 'Next execution:',
    'To give you the most power, scheduled Workflows are configured like a cronjob in Unix based systems. You found a generator and information here: %s' => 'To give you the most power, scheduled Workflows are configured like a cronjob in Unix based systems. You found a generator and information here: %s',
    'Define Authortype of comment' => 'Define Authortype of comment',
    'Insert UserID or ContactID to define an individual author.' => 'Insert UserID or ContactID to define an individual author.',
    'Define this ID as Author' => 'Define this ID as Author',
    'custom Contact ID' => 'custom Contact ID',
