...
$languageStrings = array(
    ...
    "Don't open a Workflow with IE < 9!" => "Не открывайте бизнес-процесс с помощью IE < 9!",
    ...
    "You couldn't use the Workflow Designer Admin at the moment. Workflows are not stopped!" => "Вы не можете использовать конструктор бизнес-процессов в данный момент! Бизнес-процессы не остановлены!",
    ...
    'Don\\\\\\\'t open a Workflow with IE < 9!' => 'Не запускайте бизнес-процессы с IE < 9!',
    'You couldn\\\\\\\'t use the Workflow Designer Admin at the moment. Workflows are not stopped!' => 'Существующие Бизнес-Процессы работают, однако сейчас Вы не можете использовать редактор Бизнес-Процессов.',
    'Module' => 'Модуль',
    'Record ID' => 'ID записи',
    'Record' => 'Запись',
