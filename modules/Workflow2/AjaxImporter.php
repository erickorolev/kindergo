...
$environment = array("_internal" => array("pos" => $data["position"], "file" => $data["filePath"], "total" => $data["total"], "delimiter" => $data["delimiter"], "hash" => $_REQUEST["process"]));
...
$result = array("done" => $environment["_internal"]["pos"], "ready" => true);
