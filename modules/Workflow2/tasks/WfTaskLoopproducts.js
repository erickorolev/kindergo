jQuery(function() {
    ...
    jQuery('.SourceSelection').on('click', function(e) {
        var value = jQuery('.SourceSelection:checked').val();

        jQuery('.SourceData:not([data-source="' + value + '"])').css('visibility', 'hidden');
        jQuery('.SourceData[data-source="' + value + '"]').css('visibility', 'visible');
    });
    jQuery('.SourceSelection:checked').trigger('click');
});