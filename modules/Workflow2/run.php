...
$obj = new \Workflow\Execute();
$obj->setUser($current_user);
$obj->setRecord(intval($_POST["crmid"]));
$obj->setEnvironment(array("lieferscheinNR" => $current_lieferschein_nr, "readyCount" => $readyCount, "totalCount" => $totalCount, "paket_no" => $paket_no, "ready" => $ready ? 1 : 0));
...
/**
* @var \Workflow\VTInventoryEntity
*/
$obj = \Workflow\VTEntity::getForId($_POST["crmid"]);
