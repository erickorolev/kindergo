...
/**
 * Class Timetable_Uninstall_View
 */
class Timetable_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_timetablecf table
        echo "&nbsp;&nbsp;- Delete vtiger_timetablecf table.";
        $result = $adb->pquery("DROP TABLE vtiger_timetablecf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_timetable table
        echo "&nbsp;&nbsp;- Delete vtiger_timetable table.";
        $result = $adb->pquery("DROP TABLE vtiger_timetable");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
