...
class Timetable extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_timetable';
	var $table_index= 'timetableid';
	var $related_tables = Array ('vtiger_timetablecf' => Array ( 'timetableid', 'vtiger_timetable', 'timetableid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_timetablecf', 'timetableid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_timetable', 'vtiger_timetablecf');
	...
	var $tab_name_index = Array(
		...
		'vtiger_timetable' => 'timetableid',
		'vtiger_timetablecf'=>'timetableid');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_timetable, vtiger_users,
                ...
                vtiger_timetable.timetableid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_timetable.timetableid = $id AND
