...
/**
 * Class Trips_Uninstall_View
 */
class Trips_Uninstall_View extends Settings_Vtiger_Index_View
{
    ...
    function cleanDatabase($moduleName)
    {
        ...
        // vtiger_tripscf table
        echo "&nbsp;&nbsp;- Delete vtiger_tripscf table.";
        $result = $adb->pquery("DROP TABLE vtiger_tripscf");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';

        // vtiger_trips table
        echo "&nbsp;&nbsp;- Delete vtiger_trips table.";
        $result = $adb->pquery("DROP TABLE vtiger_trips");
        echo ($result) ? " - DONE" : " - <b>ERROR</b>";
        echo '<br>';
    }
