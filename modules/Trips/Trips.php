...
class Trips extends Vtiger_CRMEntity {
    var $db;
	var $table_name = 'vtiger_trips';
	var $table_index= 'tripsid';
	var $related_tables = Array ('vtiger_tripscf' => Array ( 'tripsid', 'vtiger_trips', 'tripsid' ),);


	/**
	 * Mandatory table for supporting custom fields.
	 */
	var $customFieldTable = Array('vtiger_tripscf', 'tripsid');

	/**
	 * Mandatory for Saving, Include tables related to this module.
	 */
	var $tab_name = Array('vtiger_crmentity', 'vtiger_trips', 'vtiger_tripscf');
	...
	*/
    ...
    function get_emails($id, $cur_tab_id, $rel_tab_id, $actions=false) {
        ...
        $query = "SELECT CASE WHEN (vtiger_users.user_name NOT LIKE '') THEN $userNameSql ELSE vtiger_groups.groupname END AS user_name,
                ...
                vtiger_seactivityrel.crmid as parent_id FROM vtiger_activity, vtiger_seactivityrel, vtiger_trips, vtiger_users,
                ...
                vtiger_trips.tripsid = vtiger_seactivityrel.crmid AND vtiger_users.id = vtiger_crmentity.smownerid
                AND vtiger_crmentity.crmid = vtiger_activity.activityid  AND vtiger_trips.tripsid = $id AND
