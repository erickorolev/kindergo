        ...
        <form name="EditWorkflow" action="index.php" method="post" id="installation_step2" class="form-horizontal">
            ...
            <div class="padding1per" style="border:1px solid #ccc;">
                ...
                <div class="control-group" style="text-align: center;">
                    ...
                    <button class="btn btn-info" name="btnOrder" type="button" onclick="window.open('http://www.vtexperts.com/extension/vtiger-related-blocks-lists/')"><strong>{vtranslate('LBL_ORDER_NOW', $QUALIFIED_MODULE)}</strong></button>
                </div>
            </div>
        </div>
