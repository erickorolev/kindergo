...
<div class="modal-dialog modelContainer" style="width:600px;">
    {assign var=HEADER_TITLE value={vtranslate("Connection Editor","Settings:Workflow2")}}
            ...
            <div class="modal-content">
                ...
                <div style="overflow:hidden;padding: 10px;">
                    <table class="table table-condensed">
                        ...
                        <tr>
                            <th>Title</th>
                            <td><input type="text" style="width:90%;padding-bottom:0;" name='title' value="{$connectionTitle|htmlentities}"></td>
                        </tr>
                        {if $requireOAuth eq true}
                            <tr>
                                <th>Permission</th>
