...
<div class="container-fluid">
    ...
    <div class="summaryWidgetContainer">
        <div class="row-fluid">
            <h4><span>{vtranslate('LBL_ENABLE_MODULE', 'RelatedBlocksLists')}&nbsp;&nbsp;<input type="checkbox" name="enable_module" id="enable_module" value="1" {if $ENABLE eq '1'}checked="" {/if}/></span></h4>
        </div>
    </div>
    <div class="clearfix"></div>
    <div>
